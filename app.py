            ...
            try:
                ...
                if to_fetch:
                    ...
                    for i, tx in enumerate(to_fetch):
                        ...
                        time.sleep(1.1)  # 与 core_logic.py 保持一致
                    fetch_ph.empty()
                ...
                # --- 步骤 7: 保存上下文 ---
                # 将所有AI分析结果合并为一个字符串，作为对话的上下文（与 core_logic.py 保持一致）
